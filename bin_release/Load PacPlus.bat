...
copy /b roms\PacPlus\PacPlus.6e + roms\PacPlus\PacPlus.6f + roms\PacPlus\PacPlus.6h + roms\PacPlus\PacPlus.6j tmp\maincpu

echo Concatenating rom files : PacPlus.5e PacPlus.5f into : gfx1
copy /b roms\PacPlus\PacPlus.5e + roms\PacPlus\PacPlus.5f tmp\gfx1

echo Concatenating rom files : 82s126.1m into : 82s1261m
copy /b roms\PacPlus\82s126.1m tmp\82s1261m

echo Concatenating rom files : 82s126.3m into : 82s1263m
copy /b roms\PacPlus\82s126.3m tmp\82s1263m

echo Concatenating rom files : 82s123.7f into : 82s1237f
copy /b roms\PacPlus\82s123.7f tmp\82s1237f

echo Concatenating rom files : 82s126.4a into : 82s1264a
copy /b roms\PacPlus\82s126.4a tmp\82s1264a
