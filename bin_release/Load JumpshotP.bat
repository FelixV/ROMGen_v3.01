...
copy /b roms\JumpshotP\js6e.bin + roms\JumpshotP\js6f.bin + roms\JumpshotP\js6h.bin + roms\JumpshotP\js6j.bin tmp\maincpu

echo Concatenating rom files : 5e 5f into : gfx1
copy /b roms\JumpshotP\5e + roms\JumpshotP\5f tmp\gfx1

echo Concatenating rom files : 82s126.1m into : 82s1261m
copy /b roms\JumpshotP\82s126.1m tmp\82s1261m

echo Concatenating rom files : 82s126.3m into : 82s1263m
copy /b roms\JumpshotP\82s126.3m tmp\82s1263m

echo Concatenating rom files : prom.7f into : 82s1237f
copy /b roms\JumpshotP\prom.7f tmp\82s1237f

echo Concatenating rom files : prom.4a into : 82s1264a
copy /b roms\JumpshotP\prom.4a tmp\82s1264a
...
tools\romgen.exe tmp\maincpu ROM_PGM_0 14 m -ini:roms\JumpshotP\JumpshotP.ini > tmp\rom0.mem
